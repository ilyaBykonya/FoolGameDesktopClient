...
ApplicationWindow::ApplicationWindow(QWidget *parent)
    :QWidget{ parent },
     ...
     m_menuWindow{ new MenuWindow(m_chatSceneObject, this) },
     ...
     m_layout{ new QHBoxLayout }
    {
        ...
        QObject::connect(m_ethernetController, &ApplicationEthernetController::messageSignalReceiveUserMessage, m_chatSceneObject->chatWidget(), &ChatWidget::slotReceiveUserMessage);
        QObject::connect(m_ethernetController, &ApplicationEthernetController::messageSignalReceiveServerMessage, m_chatSceneObject->chatWidget(), &ChatWidget::slotReceiveServerMessage);
        QObject::connect(m_chatSceneObject->chatWidget(), &ChatWidget::signalSendMessage, m_ethernetController, &ApplicationEthernetController::messageSlotSendMessage);
...
void ApplicationWindow::serverSlotCreateGameInstance(Card::Suit trumpS, Card::Dignity trumpD, quint32 thisID, QList<quint32> allPlayersID, quint32 attacker, quint32 defender, quint8 sizeOfDeck)
{
    m_instanceWindow = new GameTableWidget(trumpS, trumpD, thisID, allPlayersID, attacker, defender, sizeOfDeck, m_chatSceneObject);
