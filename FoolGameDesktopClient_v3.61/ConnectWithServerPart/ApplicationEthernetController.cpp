...
void ApplicationEthernetController::serverSlotReadFromServToApp(QDataStream& dataBlock)
{
    ...
    switch(typeMessage)
    {
        ...
        case EthernetSignals::ServerSignal::ServerSignal::UserMessageSignal         :
        {
            quint16 userID;
            Canal canal;
            QString message;
        ...
        case EthernetSignals::ServerSignal::ServerSignal::ServerMessageSignal       :
        {
            QString message;
            dataBlock >> message;

            emit this->messageSignalReceiveServerMessage(message);
            break;
        }
    }
}
