...
ApplicationWindow::ApplicationWindow(const QString& hostAddress, quint16 portNumber, QWidget *parent)
    :QWidget{ parent },
     ...
     m_ethernetController{ new ApplicationEthernetController(hostAddress, portNumber, this) },
...
void ApplicationWindow::transitionFromGameInstanceToMenu(QList<UserInformation> winnersList)
{
    m_userState = UserState::UserInLobbi;
    QObject::connect(m_ethernetController, &ApplicationEthernetController::signalApplicationMakeAlert, this, &ApplicationWindow::slotMakeAlert, Qt::ConnectionType::UniqueConnection);
