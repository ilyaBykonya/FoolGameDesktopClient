...
ApplicationWindow::ApplicationWindow(QWidget *parent)
     ...
     m_layout{ new QHBoxLayout }
    {
        ...
        stateGameInstanceActive->assignProperty(this, "geometry", QSize(420, 620));
        ...
        stateRegistrationWindowActive->addTransition(m_registrationMenu, &RegistrationWindow::signalUserRegistration, stateMenuWindowActive);
        ...
        QObject::connect(m_registrationMenu, &RegistrationWindow::signalUserRegistration, m_ethernetController, &ApplicationEthernetController::applicationSlotPlayerRegistration);
        QObject::connect(m_registrationMenu, &RegistrationWindow::signalExitButtonWasClicked, this, &ApplicationWindow::signalExitButtonWasClicked);
