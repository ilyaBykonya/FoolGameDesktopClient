...
void ApplicationWindow::serverSlotCreateGameInstance(Card::Suit trumpS, Card::Dignity trumpD, UserID thisID, QList<UserInformation> allPlayers, UserID attacker, UserID defender, quint8 sizeOfDeck)
{
