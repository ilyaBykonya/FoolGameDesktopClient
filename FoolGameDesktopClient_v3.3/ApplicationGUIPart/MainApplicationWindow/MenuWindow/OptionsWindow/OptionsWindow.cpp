...
OptionsWindow::OptionsWindow(QWidget *parent)
     ...
     m_gameSettingsController{ new GameSettingObject(this) }
    {
        ...
        m_realCashOptionsButton = new QRadioButton("Real money game");
            m_realCashOptionsButton->setChecked(m_gameSettingsController->realCashOption());
            QObject::connect(m_realCashOptionsButton, &QRadioButton::toggled, m_gameSettingsController, &GameSettingObject::setRealCashOption);
        ...
        QGridLayout* optionsLayout = new QGridLayout;
            ...
            optionsLayout->addWidget(m_realCashOptionsButton, 7, 2, 1, 4);
